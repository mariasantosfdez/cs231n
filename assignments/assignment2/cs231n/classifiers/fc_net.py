...
class FullyConnectedNet(object):
    ...
    def __init__(
        ...
        # create the weight and biases for each layer
        dim_prev_layer = input_dim
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers):
          W2 += (self.params[f'W{i+1}']**2).sum()

        loss += 1/2 * self.reg * W2

        # backpropagation
        # last affine layer
        dout, dw, db = affine_backward(dloss, scores_cache)
