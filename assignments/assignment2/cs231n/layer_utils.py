...
def affine_batchnorm_relu_forward(x, w, b, gamma, beta, bn_param):
    """Convenience layer that performs an affine transform, batchnorm, and a ReLU.

    Inputs:
    - x: Input to the affine layer
    - w, b: Weights for the affine layer
    - gamma, beta: scaling and shift parameters for batchnorm
...
def affine_layernorm_relu_forward(x, w, b, gamma, beta, ln_param):
    """Convenience layer that performs an affine transform, layernorm, and a ReLU.

    Inputs:
    - x: Input to the affine layer
    - w, b: Weights for the affine layer
    - gamma, beta: scaling and shift parameters for layernorm
    - ln_param: parameters for batchnorm 
    ...
    """
    a, fc_cache = affine_forward(x, w, b)
    a_bn, ln_cache = layernorm_forward(a, gamma, beta, ln_param)
    out, relu_cache = relu_forward(a_bn)
